...
func WithBatchSize(batchSize int32) ExporterOption {
	return func(e *Exporter) {
		e.batchSize = batchSize
	}
}

func WithNamespaces(namespaces []string) ExporterOption {
	return func(e *Exporter) {
		e.namespaces = namespaces
	}
}

func WithAllNamespaces() ExporterOption {
	return func(e *Exporter) {
		e.allNamespaces = true
	}
}

func NewExporter(store Lister, opts ...ExporterOption) *Exporter {
	e := &Exporter{
		store:     store,
...
func (e *Exporter) ExportYAML(ctx context.Context, w io.Writer) error {
	...
	if e.allNamespaces {
		...
		e.namespaces = intermediateNamespaces
	}
